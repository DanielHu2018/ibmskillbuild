  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-4">
      <div className="mb-3 flex items-center justify-between">
        ...
        <span className="rounded-full bg-emerald-500/15 px-2 py-0.5 text-[9px] font-semibold text-emerald-400 uppercase">
          SR 11-7 Compliant
        </span>
      </div>
            ...
            <div key={i} className={cn('flex items-start gap-3 rounded-lg px-3 py-2', config.bg)}>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-semibold text-slate-400">{entry.component}</span>
                </div>
                <p className="text-[11px] text-slate-300 mt-0.5">{entry.action}</p>
              </div>
